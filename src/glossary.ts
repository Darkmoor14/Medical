// Romanian → English clinical glossary. PubMed is indexed in English, so
// Romanian search terms ("insuficiență cardiacă") are rewritten to their
// English equivalents ("heart failure") before searching. Matching ignores
// case and missing diacritics; upper-case abbreviations match exactly.
...
const BUILT_IN: [string, string][] = [
  ...
  // More conditions often searched
  ["insuficiență renală acută", "acute kidney injury"],
  ["insuficiență respiratorie", "respiratory failure"],
  ["insuficiență hepatică", "liver failure"],
  ["boală cronică de rinichi", "chronic kidney disease"],
  ["boală coronariană", "coronary artery disease"],
  ["angină pectorală", "angina pectoris"],
  ["embolie pulmonară", "pulmonary embolism"],
  ["tromboză venoasă profundă", "deep vein thrombosis"],
  ["astm bronșic", "asthma"],
  ["tuberculoză(?: pulmonară)?", "tuberculosis"],
  ["pneumonie", "pneumonia"],
  ["sepsis", "sepsis"],
  ["infecție urinară", "urinary tract infection"],
  ["infecție de tract urinar", "urinary tract infection"],
  ["hepatită(?: cronică)?(?: virală)? B", "hepatitis B"],
  ["hepatită(?: cronică)?(?: virală)? C", "hepatitis C"],
  ["pancreatită acută", "acute pancreatitis"],
  ["pancreatită cronică", "chronic pancreatitis"],
  ["colecistită", "cholecystitis"],
  ["apendicită", "appendicitis"],
  ["boală Crohn", "Crohn disease"],
  ["boala Crohn", "Crohn disease"],
  ["colită ulcerativă", "ulcerative colitis"],
  ["boală celiacă", "celiac disease"],
  ["ulcer (?:gastric|peptic)", "peptic ulcer"],
  ["reflux gastroesofagian", "gastroesophageal reflux"],
  ["cancer(?:ul)? (?:de )?sân", "breast cancer"],
  ["cancer(?:ul)? pulmonar", "lung cancer"],
  ["cancer(?:ul)? colorectal", "colorectal cancer"],
  ["cancer(?:ul)? de prostată", "prostate cancer"],
  ["cancer(?:ul)? gastric", "gastric cancer"],
  ["cancer(?:ul)? pancreatic", "pancreatic cancer"],
  ["cancer(?:ul)? de col uterin", "cervical cancer"],
  ["leucemie", "leukemia"],
  ["limfom", "lymphoma"],
  ["mielom multiplu", "multiple myeloma"],
  ["boala Parkinson", "Parkinson disease"],
  ["boala Alzheimer", "Alzheimer disease"],
  ["demență", "dementia"],
  ...
  ["tulburare bipolară", "bipolar disorder"],
  ["obezitate", "obesity"],
  ["osteoporoză", "osteoporosis"],
  ["artrită reumatoidă", "rheumatoid arthritis"],
  ["poliartrită reumatoidă", "rheumatoid arthritis"],
  ["lupus eritematos sistemic", "systemic lupus erythematosus"],
  ["gută", "gout"],
  ...
  ["diabet gestațional", "gestational diabetes"],
  // Study and search vocabulary
  ["tratament(?:ul)?", "treatment"],
  ["terapie", "therapy"],
  ["diagnostic(?:ul)?", "diagnosis"],
  ["prognostic(?:ul)?", "prognosis"],
  ["mortalitate", "mortality"],
  ["complicați(?:i|ile)", "complications"],
  ["factori de risc", "risk factors"],
  ["prevenție", "prevention"],
  ["screening", "screening"],
  ["ghid(?:uri)?(?: clinic(?:e)?)?", "guideline"],
  ["studiu randomizat", "randomized controlled trial"],
  ["meta-?analiză", "meta-analysis"],
  ["copii", "children"],
  ["adulți", "adults"],
  ["vârstnici", "elderly"],
  ["femei", "women"],
  ...
  ["siguranță", "safety"],
  ["reacții adverse", "adverse effects"],
  ["efecte adverse", "adverse effects"],
  ["doză", "dose"],
  ["intervenție chirurgicală", "surgery"],
  ["chirurgie", "surgery"],
